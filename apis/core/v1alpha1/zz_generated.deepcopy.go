...
func (in *BackupBatchStatus) DeepCopyInto(out *BackupBatchStatus) {
	*out = *in
	if in.OffshootStatus != nil {
		in, out := &in.OffshootStatus, &out.OffshootStatus
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackupPausedStatus) DeepCopyInto(out *BackupPausedStatus) {
	*out = *in
	if in.Invoker != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupPausedStatus.
func (in *BackupPausedStatus) DeepCopy() *BackupPausedStatus {
	if in == nil {
		return nil
	}
	out := new(BackupPausedStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VerificationStrategy) DeepCopyInto(out *VerificationStrategy) {
	*out = *in
	if in.Verifier != nil {
		...
		*out = new(apis.TypedObjectReference)
		(*in).DeepCopyInto(*out)
	}
	if in.Params != nil {
		in, out := &in.Params, &out.Params
