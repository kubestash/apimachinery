...
import (
	...
	"stash.appscode.dev/kubestash/apis/addons/fuzzer"
	"stash.appscode.dev/kubestash/apis/addons/v1alpha1"
...
func TestPruneTypes(t *testing.T) {
	...
	// v1alpha1
	if crd := (v1alpha1.Addon{}).CustomResourceDefinition(); crd.V1 != nil {
