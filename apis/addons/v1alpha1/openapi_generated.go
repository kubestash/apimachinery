...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubestash.dev/apimachinery/apis.AllowedNamespaces":                           schema_kubestashdev_kubestash_apis_AllowedNamespaces(ref),
		"kubestash.dev/apimachinery/apis.ParameterDefinition":                         schema_kubestashdev_kubestash_apis_ParameterDefinition(ref),
		"kubestash.dev/apimachinery/apis.UsagePolicy":                                 schema_kubestashdev_kubestash_apis_UsagePolicy(ref),
		"kubestash.dev/apimachinery/apis.VolumeSource":                                schema_kubestashdev_kubestash_apis_VolumeSource(ref),
		"kubestash.dev/apimachinery/apis/addons/v1alpha1.Addon":                       schema_kubestash_apis_addons_v1alpha1_Addon(ref),
		"kubestash.dev/apimachinery/apis/addons/v1alpha1.AddonList":                   schema_kubestash_apis_addons_v1alpha1_AddonList(ref),
		"kubestash.dev/apimachinery/apis/addons/v1alpha1.AddonSpec":                   schema_kubestash_apis_addons_v1alpha1_AddonSpec(ref),
		"kubestash.dev/apimachinery/apis/addons/v1alpha1.Function":                    schema_kubestash_apis_addons_v1alpha1_Function(ref),
		"kubestash.dev/apimachinery/apis/addons/v1alpha1.FunctionList":                schema_kubestash_apis_addons_v1alpha1_FunctionList(ref),
		"kubestash.dev/apimachinery/apis/addons/v1alpha1.FunctionSpec":                schema_kubestash_apis_addons_v1alpha1_FunctionSpec(ref),
		"kubestash.dev/apimachinery/apis/addons/v1alpha1.Task":                        schema_kubestash_apis_addons_v1alpha1_Task(ref),
		"kubestash.dev/apimachinery/apis/addons/v1alpha1.VolumeTemplate":              schema_kubestash_apis_addons_v1alpha1_VolumeTemplate(ref),
	}
}
...
func schema_kubestashdev_kubestash_apis_UsagePolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"allowedNamespaces": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("kubestash.dev/apimachinery/apis.AllowedNamespaces"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"kubestash.dev/apimachinery/apis.AllowedNamespaces"},
	}
}
...
func schema_kubestash_apis_addons_v1alpha1_Addon(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubestash.dev/apimachinery/apis/addons/v1alpha1.AddonSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubestash.dev/apimachinery/apis/addons/v1alpha1.AddonSpec"},
	}
}

func schema_kubestash_apis_addons_v1alpha1_AddonList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AddonList contains a list of Addon",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubestash.dev/apimachinery/apis/addons/v1alpha1.Addon"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubestash.dev/apimachinery/apis/addons/v1alpha1.Addon"},
	}
}

func schema_kubestash_apis_addons_v1alpha1_AddonSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AddonSpec defines the specification for backup and restore tasks.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"backupTasks": {
						SchemaProps: spec.SchemaProps{
							Description: "BackupTasks specifies a list of backup tasks that can be performed by the addon.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubestash.dev/apimachinery/apis/addons/v1alpha1.Task"),
									},
								},
							},
						},
					...
					"restoreTasks": {
						SchemaProps: spec.SchemaProps{
							Description: "RestoreTasks specifies a list of restore tasks that can be performed by the addon.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"kubestash.dev/apimachinery/apis/addons/v1alpha1.Task"},
	}
}

func schema_kubestash_apis_addons_v1alpha1_Function(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubestash.dev/apimachinery/apis/addons/v1alpha1.FunctionSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubestash.dev/apimachinery/apis/addons/v1alpha1.FunctionSpec"},
	}
}

func schema_kubestash_apis_addons_v1alpha1_FunctionList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubestash.dev/apimachinery/apis/addons/v1alpha1.Function"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubestash.dev/apimachinery/apis/addons/v1alpha1.Function"},
	}
}

func schema_kubestash_apis_addons_v1alpha1_FunctionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"image": {
						SchemaProps: spec.SchemaProps{
							Description: "Image specifies the docker image name. More info: https://kubernetes.io/docs/concepts/containers/images This field is optional to allow higher level config management to default or override container images in workload controllers like Deployments and StatefulSets.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"args": {
						SchemaProps: spec.SchemaProps{
							Description: "Args specifies the arguments to the entrypoint. The docker image's CMD is used if this is not provided. Variable references $(VAR_NAME) are expanded using the container's environment. If a variable cannot be resolved, the reference in the input string will be unchanged. The $(VAR_NAME) syntax can be escaped with a double $$, ie: $$(VAR_NAME). Escaped references will never be expanded, regardless of whether the variable exists or not. Cannot be updated. More info: https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"workingDir": {
						SchemaProps: spec.SchemaProps{
							Description: "WorkDir specifies the container's working directory. If not specified, the container runtime's default will be used, which might be configured in the container image. Cannot be updated.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"ports": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Ports specifies the list of ports to expose from the container. Exposing a port here gives the system additional information about the network connections a container uses, but is primarily informational. Not specifying a port here DOES NOT prevent that port from being exposed. Any port which is listening on the default \"0.0.0.0\" address inside a container will be accessible from the network. Cannot be updated.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"volumeMounts": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "VolumeMounts specifies the Pod volumes to mount into the container's filesystem. Cannot be updated.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_kubestash_apis_addons_v1alpha1_Task(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Task defines the specification of a backup/restore task.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name specifies the name of the task. The name of a Task should indicate what this task does. For example, a name LogicalBackup indicate that this task performs a logical backup of a database.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"function": {
						SchemaProps: spec.SchemaProps{
							Description: "Function specifies the name of a Function CR that defines a container definition which will execute the backup/restore logic for a particular application.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"driver": {
						SchemaProps: spec.SchemaProps{
							Description: "Driver specifies the underlying tool that will be used to upload the data to the backend storage. Valid values are: - \"Restic\": The underlying tool is [restic](https://restic.net/). - \"WalG\": The underlying tool is [wal-g](https://github.com/wal-g/wal-g).",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"parameters": {
						SchemaProps: spec.SchemaProps{
							Description: "Parameters defines a list of parameters that is used by the task to execute its logic.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubestash.dev/apimachinery/apis.ParameterDefinition"),
									},
								},
							},
						},
					...
					"volumeTemplate": {
						SchemaProps: spec.SchemaProps{
							Description: "VolumeTemplate specifies a list of volume templates that is used by the respective backup/restore Job to execute its logic. User can overwrite these volume templates using `addonVolumes` field of BackupConfiguration/BackupBatch.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubestash.dev/apimachinery/apis/addons/v1alpha1.VolumeTemplate"),
									},
								},
							},
						},
					...
					"volumeMounts": {
						SchemaProps: spec.SchemaProps{
							Description: "VolumeMounts specifies the mount path of the volumes specified in the VolumeTemplate section. These volumes will be mounted directly on the Job/Container created/injected by Stash operator. If the volume type is VolumeClaimTemplate, then Stash operator is responsible for creating the volume.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.VolumeMount", "kubestash.dev/apimachinery/apis.ParameterDefinition", "kubestash.dev/apimachinery/apis/addons/v1alpha1.VolumeTemplate"},
	}
}

func schema_kubestash_apis_addons_v1alpha1_VolumeTemplate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VolumeTemplate specifies the name, usage, and the source of volume that will be used by the addon to execute it's backup/restore task.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
					...
					"usage": {
						SchemaProps: spec.SchemaProps{
							Description: "Usage specifies the usage of the volume.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"source": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("kubestash.dev/apimachinery/apis.VolumeSource"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"kubestash.dev/apimachinery/apis.VolumeSource"},
	}
}
