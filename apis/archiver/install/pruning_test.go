...
import (
	...
	"kubestash.dev/apimachinery/apis/archiver/fuzzer"
	"kubestash.dev/apimachinery/apis/archiver/v1alpha1"
...
func TestPruneTypes(t *testing.T) {
	...
	// v1alpha1
	if crd := (&v1alpha1.KubeVirtArchiver{}).CustomResourceDefinition(); crd.V1 != nil {
