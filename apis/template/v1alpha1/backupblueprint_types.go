...
type BackupBlueprintSpec struct {
	...
	// Foo is an example field of BackupBlueprint. Edit backupblueprint_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// BackupBlueprintStatus defines the observed state of BackupBlueprint
