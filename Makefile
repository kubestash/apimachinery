...
API_GROUPS           ?= kubestash:addons:v1alpha1,kubestash:core:v1alpha1,kubestash:storage:v1alpha1
...
SRC_PKGS := apis crds controllers # directories which hold app source excluding tests (not vendored)
...
crds_to_patch := stash.appscode.com_backupstorages.yaml
...
push-to-kind: container
	...
	@kind load docker-image $(REGISTRY)/stash-enterprise:$(TAG)
